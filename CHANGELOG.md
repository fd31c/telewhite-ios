...
## 2026-07-12 (невидимка и синхронизация иконки)
...
- **[Исправлено]** Иконка у строки «Telewhite Mods» в настройках теперь реально показывает выбранную
  и��онку приложения: загрузка через `UIImage(named:in:getAppBundle())` — тот же механизм, что в пикере
...
- **[Улучшено]** `95dbbdd` — **Ghost Mode**: пока приложение активно ис��ользуется в режиме невидимки,
