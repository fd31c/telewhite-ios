...
- **[Улучшено]** — Иконки разделов Telewhite Mods переработаны: вместо
  самодельных векторных путей используются родные глифы Telegram
  (`renderSettingsIcon` + Item List/Icons) на цветных квадратах — единый стиль
